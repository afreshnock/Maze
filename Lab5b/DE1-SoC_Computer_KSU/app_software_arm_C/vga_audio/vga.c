...
int main(int argc,char ** argv) {
    ...
    void *virtual_base;
    int fd;
  	int audio_control, audio_fifo, audio_left_read, audio_left_write, audio_right_read, audio_right_write;
   ...
   PHYSMEM_32((AUDIO_BASE)) = 0x00000C; // Clear the Read and Write FIFOs
   PHYSMEM_32((AUDIO_BASE)) = 0x000002; // Clear the Read and Write FIFOs   
   
   while(1)
   {
	   audio_fifo =  PHYSMEM_32((AUDIO_BASE+4));
