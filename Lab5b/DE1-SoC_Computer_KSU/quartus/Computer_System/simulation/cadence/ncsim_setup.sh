...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/Computer_System_mm_interconnect_1_router_005.sv"                            -work router_005                                         -cdslib ./cds_libs/router_005.cds.lib                                        
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/altera_avalon_sc_fifo.v"                                                    -work VGA_Subsystem_char_buffer_slave_agent_rsp_fifo     -cdslib ./cds_libs/VGA_Subsystem_char_buffer_slave_agent_rsp_fifo.cds.lib    
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/Computer_System_SysID.v"                                                    -work SysID                                              -cdslib ./cds_libs/SysID.cds.lib                                             
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/Computer_System_Audio_space.v"                                              -work Audio_space                                        -cdslib ./cds_libs/Audio_space.cds.lib                                       
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/Computer_System_Audio_ctrl.v"                                               -work Audio_ctrl                                         -cdslib ./cds_libs/Audio_ctrl.cds.lib                                        
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/Computer_System_Audio_DACL_Dat.v"                                           -work Audio_DACL_Dat                                     -cdslib ./cds_libs/Audio_DACL_Dat.cds.lib                                    
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/Computer_System_Audio_ADCL_Dat.v"                                           -work Audio_ADCL_Dat                                     -cdslib ./cds_libs/Audio_ADCL_Dat.cds.lib                                    
