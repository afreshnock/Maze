...
module Computer_System_mm_interconnect_2 (
		...
		output wire [1:0]  Audio_ADCL_Dat_s1_address,                                                //                                                  Audio_ADCL_Dat_s1.address
		input  wire [31:0] Audio_ADCL_Dat_s1_readdata,                                               //                                                                   .readdata
		output wire [1:0]  Audio_ctrl_s1_address,                                                    //                                                      Audio_ctrl_s1.address
		output wire        Audio_ctrl_s1_write,                                                      //                                                                   .write
		input  wire [31:0] Audio_ctrl_s1_readdata,                                                   //                                                                   .readdata
		output wire [31:0] Audio_ctrl_s1_writedata,                                                  //                                                                   .writedata
		output wire        Audio_ctrl_s1_chipselect,                                                 //                                                                   .chipselect
		output wire [1:0]  Audio_DACL_Dat_s1_address,                                                //                                                  Audio_DACL_Dat_s1.address
		output wire        Audio_DACL_Dat_s1_write,                                                  //                                                                   .write
		input  wire [31:0] Audio_DACL_Dat_s1_readdata,                                               //                                                                   .readdata
		output wire [31:0] Audio_DACL_Dat_s1_writedata,                                              //                                                                   .writedata
		output wire        Audio_DACL_Dat_s1_chipselect,                                             //                                                                   .chipselect
		output wire [1:0]  Audio_space_s1_address,                                                   //                                                     Audio_space_s1.address
		input  wire [31:0] Audio_space_s1_readdata,                                                  //                                                                   .readdata
	...
	wire   [31:0] audio_ctrl_s1_agent_m0_readdata;                                             // Audio_ctrl_s1_translator:uav_readdata -> Audio_ctrl_s1_agent:m0_readdata
	wire          audio_ctrl_s1_agent_m0_waitrequest;                                          // Audio_ctrl_s1_translator:uav_waitrequest -> Audio_ctrl_s1_agent:m0_waitrequest
	wire          audio_ctrl_s1_agent_m0_debugaccess;                                          // Audio_ctrl_s1_agent:m0_debugaccess -> Audio_ctrl_s1_translator:uav_debugaccess
	wire   [20:0] audio_ctrl_s1_agent_m0_address;                                              // Audio_ctrl_s1_agent:m0_address -> Audio_ctrl_s1_translator:uav_address
	wire    [3:0] audio_ctrl_s1_agent_m0_byteenable;                                           // Audio_ctrl_s1_agent:m0_byteenable -> Audio_ctrl_s1_translator:uav_byteenable
	wire          audio_ctrl_s1_agent_m0_read;                                                 // Audio_ctrl_s1_agent:m0_read -> Audio_ctrl_s1_translator:uav_read
	wire          audio_ctrl_s1_agent_m0_readdatavalid;                                        // Audio_ctrl_s1_translator:uav_readdatavalid -> Audio_ctrl_s1_agent:m0_readdatavalid
	wire          audio_ctrl_s1_agent_m0_lock;                                                 // Audio_ctrl_s1_agent:m0_lock -> Audio_ctrl_s1_translator:uav_lock
	wire   [31:0] audio_ctrl_s1_agent_m0_writedata;                                            // Audio_ctrl_s1_agent:m0_writedata -> Audio_ctrl_s1_translator:uav_writedata
	wire          audio_ctrl_s1_agent_m0_write;                                                // Audio_ctrl_s1_agent:m0_write -> Audio_ctrl_s1_translator:uav_write
	wire    [2:0] audio_ctrl_s1_agent_m0_burstcount;                                           // Audio_ctrl_s1_agent:m0_burstcount -> Audio_ctrl_s1_translator:uav_burstcount
	wire          audio_ctrl_s1_agent_rf_source_valid;                                         // Audio_ctrl_s1_agent:rf_source_valid -> Audio_ctrl_s1_agent_rsp_fifo:in_valid
	wire  [118:0] audio_ctrl_s1_agent_rf_source_data;                                          // Audio_ctrl_s1_agent:rf_source_data -> Audio_ctrl_s1_agent_rsp_fifo:in_data
	wire          audio_ctrl_s1_agent_rf_source_ready;                                         // Audio_ctrl_s1_agent_rsp_fifo:in_ready -> Audio_ctrl_s1_agent:rf_source_ready
	wire          audio_ctrl_s1_agent_rf_source_startofpacket;                                 // Audio_ctrl_s1_agent:rf_source_startofpacket -> Audio_ctrl_s1_agent_rsp_fifo:in_startofpacket
	wire          audio_ctrl_s1_agent_rf_source_endofpacket;                                   // Audio_ctrl_s1_agent:rf_source_endofpacket -> Audio_ctrl_s1_agent_rsp_fifo:in_endofpacket
	wire          audio_ctrl_s1_agent_rsp_fifo_out_valid;                                      // Audio_ctrl_s1_agent_rsp_fifo:out_valid -> Audio_ctrl_s1_agent:rf_sink_valid
	wire  [118:0] audio_ctrl_s1_agent_rsp_fifo_out_data;                                       // Audio_ctrl_s1_agent_rsp_fifo:out_data -> Audio_ctrl_s1_agent:rf_sink_data
	wire          audio_ctrl_s1_agent_rsp_fifo_out_ready;                                      // Audio_ctrl_s1_agent:rf_sink_ready -> Audio_ctrl_s1_agent_rsp_fifo:out_ready
	wire          audio_ctrl_s1_agent_rsp_fifo_out_startofpacket;                              // Audio_ctrl_s1_agent_rsp_fifo:out_startofpacket -> Audio_ctrl_s1_agent:rf_sink_startofpacket
	wire          audio_ctrl_s1_agent_rsp_fifo_out_endofpacket;                                // Audio_ctrl_s1_agent_rsp_fifo:out_endofpacket -> Audio_ctrl_s1_agent:rf_sink_endofpacket
	wire          audio_ctrl_s1_agent_rdata_fifo_src_valid;                                    // Audio_ctrl_s1_agent:rdata_fifo_src_valid -> Audio_ctrl_s1_agent_rdata_fifo:in_valid
	wire   [33:0] audio_ctrl_s1_agent_rdata_fifo_src_data;                                     // Audio_ctrl_s1_agent:rdata_fifo_src_data -> Audio_ctrl_s1_agent_rdata_fifo:in_data
	wire          audio_ctrl_s1_agent_rdata_fifo_src_ready;                                    // Audio_ctrl_s1_agent_rdata_fifo:in_ready -> Audio_ctrl_s1_agent:rdata_fifo_src_ready
	wire   [31:0] audio_space_s1_agent_m0_readdata;                                            // Audio_space_s1_translator:uav_readdata -> Audio_space_s1_agent:m0_readdata
	wire          audio_space_s1_agent_m0_waitrequest;                                         // Audio_space_s1_translator:uav_waitrequest -> Audio_space_s1_agent:m0_waitrequest
	wire          audio_space_s1_agent_m0_debugaccess;                                         // Audio_space_s1_agent:m0_debugaccess -> Audio_space_s1_translator:uav_debugaccess
	wire   [20:0] audio_space_s1_agent_m0_address;                                             // Audio_space_s1_agent:m0_address -> Audio_space_s1_translator:uav_address
	wire    [3:0] audio_space_s1_agent_m0_byteenable;                                          // Audio_space_s1_agent:m0_byteenable -> Audio_space_s1_translator:uav_byteenable
	wire          audio_space_s1_agent_m0_read;                                                // Audio_space_s1_agent:m0_read -> Audio_space_s1_translator:uav_read
	wire          audio_space_s1_agent_m0_readdatavalid;                                       // Audio_space_s1_translator:uav_readdatavalid -> Audio_space_s1_agent:m0_readdatavalid
	wire          audio_space_s1_agent_m0_lock;                                                // Audio_space_s1_agent:m0_lock -> Audio_space_s1_translator:uav_lock
	wire   [31:0] audio_space_s1_agent_m0_writedata;                                           // Audio_space_s1_agent:m0_writedata -> Audio_space_s1_translator:uav_writedata
	wire          audio_space_s1_agent_m0_write;                                               // Audio_space_s1_agent:m0_write -> Audio_space_s1_translator:uav_write
	wire    [2:0] audio_space_s1_agent_m0_burstcount;                                          // Audio_space_s1_agent:m0_burstcount -> Audio_space_s1_translator:uav_burstcount
	wire          audio_space_s1_agent_rf_source_valid;                                        // Audio_space_s1_agent:rf_source_valid -> Audio_space_s1_agent_rsp_fifo:in_valid
	wire  [118:0] audio_space_s1_agent_rf_source_data;                                         // Audio_space_s1_agent:rf_source_data -> Audio_space_s1_agent_rsp_fifo:in_data
	wire          audio_space_s1_agent_rf_source_ready;                                        // Audio_space_s1_agent_rsp_fifo:in_ready -> Audio_space_s1_agent:rf_source_ready
	wire          audio_space_s1_agent_rf_source_startofpacket;                                // Audio_space_s1_agent:rf_source_startofpacket -> Audio_space_s1_agent_rsp_fifo:in_startofpacket
	wire          audio_space_s1_agent_rf_source_endofpacket;                                  // Audio_space_s1_agent:rf_source_endofpacket -> Audio_space_s1_agent_rsp_fifo:in_endofpacket
	wire          audio_space_s1_agent_rsp_fifo_out_valid;                                     // Audio_space_s1_agent_rsp_fifo:out_valid -> Audio_space_s1_agent:rf_sink_valid
	wire  [118:0] audio_space_s1_agent_rsp_fifo_out_data;                                      // Audio_space_s1_agent_rsp_fifo:out_data -> Audio_space_s1_agent:rf_sink_data
	wire          audio_space_s1_agent_rsp_fifo_out_ready;                                     // Audio_space_s1_agent:rf_sink_ready -> Audio_space_s1_agent_rsp_fifo:out_ready
	wire          audio_space_s1_agent_rsp_fifo_out_startofpacket;                             // Audio_space_s1_agent_rsp_fifo:out_startofpacket -> Audio_space_s1_agent:rf_sink_startofpacket
	wire          audio_space_s1_agent_rsp_fifo_out_endofpacket;                               // Audio_space_s1_agent_rsp_fifo:out_endofpacket -> Audio_space_s1_agent:rf_sink_endofpacket
	wire          audio_space_s1_agent_rdata_fifo_src_valid;                                   // Audio_space_s1_agent:rdata_fifo_src_valid -> Audio_space_s1_agent_rdata_fifo:in_valid
	wire   [33:0] audio_space_s1_agent_rdata_fifo_src_data;                                    // Audio_space_s1_agent:rdata_fifo_src_data -> Audio_space_s1_agent_rdata_fifo:in_data
	wire          audio_space_s1_agent_rdata_fifo_src_ready;                                   // Audio_space_s1_agent_rdata_fifo:in_ready -> Audio_space_s1_agent:rdata_fifo_src_ready
	wire   [31:0] audio_dacl_dat_s1_agent_m0_readdata;                                         // Audio_DACL_Dat_s1_translator:uav_readdata -> Audio_DACL_Dat_s1_agent:m0_readdata
	wire          audio_dacl_dat_s1_agent_m0_waitrequest;                                      // Audio_DACL_Dat_s1_translator:uav_waitrequest -> Audio_DACL_Dat_s1_agent:m0_waitrequest
	wire          audio_dacl_dat_s1_agent_m0_debugaccess;                                      // Audio_DACL_Dat_s1_agent:m0_debugaccess -> Audio_DACL_Dat_s1_translator:uav_debugaccess
	wire   [20:0] audio_dacl_dat_s1_agent_m0_address;                                          // Audio_DACL_Dat_s1_agent:m0_address -> Audio_DACL_Dat_s1_translator:uav_address
	wire    [3:0] audio_dacl_dat_s1_agent_m0_byteenable;                                       // Audio_DACL_Dat_s1_agent:m0_byteenable -> Audio_DACL_Dat_s1_translator:uav_byteenable
	wire          audio_dacl_dat_s1_agent_m0_read;                                             // Audio_DACL_Dat_s1_agent:m0_read -> Audio_DACL_Dat_s1_translator:uav_read
	wire          audio_dacl_dat_s1_agent_m0_readdatavalid;                                    // Audio_DACL_Dat_s1_translator:uav_readdatavalid -> Audio_DACL_Dat_s1_agent:m0_readdatavalid
	wire          audio_dacl_dat_s1_agent_m0_lock;                                             // Audio_DACL_Dat_s1_agent:m0_lock -> Audio_DACL_Dat_s1_translator:uav_lock
	wire   [31:0] audio_dacl_dat_s1_agent_m0_writedata;                                        // Audio_DACL_Dat_s1_agent:m0_writedata -> Audio_DACL_Dat_s1_translator:uav_writedata
	wire          audio_dacl_dat_s1_agent_m0_write;                                            // Audio_DACL_Dat_s1_agent:m0_write -> Audio_DACL_Dat_s1_translator:uav_write
	wire    [2:0] audio_dacl_dat_s1_agent_m0_burstcount;                                       // Audio_DACL_Dat_s1_agent:m0_burstcount -> Audio_DACL_Dat_s1_translator:uav_burstcount
	wire          audio_dacl_dat_s1_agent_rf_source_valid;                                     // Audio_DACL_Dat_s1_agent:rf_source_valid -> Audio_DACL_Dat_s1_agent_rsp_fifo:in_valid
	wire  [118:0] audio_dacl_dat_s1_agent_rf_source_data;                                      // Audio_DACL_Dat_s1_agent:rf_source_data -> Audio_DACL_Dat_s1_agent_rsp_fifo:in_data
	wire          audio_dacl_dat_s1_agent_rf_source_ready;                                     // Audio_DACL_Dat_s1_agent_rsp_fifo:in_ready -> Audio_DACL_Dat_s1_agent:rf_source_ready
	wire          audio_dacl_dat_s1_agent_rf_source_startofpacket;                             // Audio_DACL_Dat_s1_agent:rf_source_startofpacket -> Audio_DACL_Dat_s1_agent_rsp_fifo:in_startofpacket
	wire          audio_dacl_dat_s1_agent_rf_source_endofpacket;                               // Audio_DACL_Dat_s1_agent:rf_source_endofpacket -> Audio_DACL_Dat_s1_agent_rsp_fifo:in_endofpacket
	wire          audio_dacl_dat_s1_agent_rsp_fifo_out_valid;                                  // Audio_DACL_Dat_s1_agent_rsp_fifo:out_valid -> Audio_DACL_Dat_s1_agent:rf_sink_valid
	wire  [118:0] audio_dacl_dat_s1_agent_rsp_fifo_out_data;                                   // Audio_DACL_Dat_s1_agent_rsp_fifo:out_data -> Audio_DACL_Dat_s1_agent:rf_sink_data
	wire          audio_dacl_dat_s1_agent_rsp_fifo_out_ready;                                  // Audio_DACL_Dat_s1_agent:rf_sink_ready -> Audio_DACL_Dat_s1_agent_rsp_fifo:out_ready
	wire          audio_dacl_dat_s1_agent_rsp_fifo_out_startofpacket;                          // Audio_DACL_Dat_s1_agent_rsp_fifo:out_startofpacket -> Audio_DACL_Dat_s1_agent:rf_sink_startofpacket
	wire          audio_dacl_dat_s1_agent_rsp_fifo_out_endofpacket;                            // Audio_DACL_Dat_s1_agent_rsp_fifo:out_endofpacket -> Audio_DACL_Dat_s1_agent:rf_sink_endofpacket
	wire          audio_dacl_dat_s1_agent_rdata_fifo_src_valid;                                // Audio_DACL_Dat_s1_agent:rdata_fifo_src_valid -> Audio_DACL_Dat_s1_agent_rdata_fifo:in_valid
	wire   [33:0] audio_dacl_dat_s1_agent_rdata_fifo_src_data;                                 // Audio_DACL_Dat_s1_agent:rdata_fifo_src_data -> Audio_DACL_Dat_s1_agent_rdata_fifo:in_data
	wire          audio_dacl_dat_s1_agent_rdata_fifo_src_ready;                                // Audio_DACL_Dat_s1_agent_rdata_fifo:in_ready -> Audio_DACL_Dat_s1_agent:rdata_fifo_src_ready
	wire   [31:0] audio_adcl_dat_s1_agent_m0_readdata;                                         // Audio_ADCL_Dat_s1_translator:uav_readdata -> Audio_ADCL_Dat_s1_agent:m0_readdata
	wire          audio_adcl_dat_s1_agent_m0_waitrequest;                                      // Audio_ADCL_Dat_s1_translator:uav_waitrequest -> Audio_ADCL_Dat_s1_agent:m0_waitrequest
	wire          audio_adcl_dat_s1_agent_m0_debugaccess;                                      // Audio_ADCL_Dat_s1_agent:m0_debugaccess -> Audio_ADCL_Dat_s1_translator:uav_debugaccess
	wire   [20:0] audio_adcl_dat_s1_agent_m0_address;                                          // Audio_ADCL_Dat_s1_agent:m0_address -> Audio_ADCL_Dat_s1_translator:uav_address
	wire    [3:0] audio_adcl_dat_s1_agent_m0_byteenable;                                       // Audio_ADCL_Dat_s1_agent:m0_byteenable -> Audio_ADCL_Dat_s1_translator:uav_byteenable
	wire          audio_adcl_dat_s1_agent_m0_read;                                             // Audio_ADCL_Dat_s1_agent:m0_read -> Audio_ADCL_Dat_s1_translator:uav_read
	wire          audio_adcl_dat_s1_agent_m0_readdatavalid;                                    // Audio_ADCL_Dat_s1_translator:uav_readdatavalid -> Audio_ADCL_Dat_s1_agent:m0_readdatavalid
	wire          audio_adcl_dat_s1_agent_m0_lock;                                             // Audio_ADCL_Dat_s1_agent:m0_lock -> Audio_ADCL_Dat_s1_translator:uav_lock
	wire   [31:0] audio_adcl_dat_s1_agent_m0_writedata;                                        // Audio_ADCL_Dat_s1_agent:m0_writedata -> Audio_ADCL_Dat_s1_translator:uav_writedata
	wire          audio_adcl_dat_s1_agent_m0_write;                                            // Audio_ADCL_Dat_s1_agent:m0_write -> Audio_ADCL_Dat_s1_translator:uav_write
	wire    [2:0] audio_adcl_dat_s1_agent_m0_burstcount;                                       // Audio_ADCL_Dat_s1_agent:m0_burstcount -> Audio_ADCL_Dat_s1_translator:uav_burstcount
	wire          audio_adcl_dat_s1_agent_rf_source_valid;                                     // Audio_ADCL_Dat_s1_agent:rf_source_valid -> Audio_ADCL_Dat_s1_agent_rsp_fifo:in_valid
	wire  [118:0] audio_adcl_dat_s1_agent_rf_source_data;                                      // Audio_ADCL_Dat_s1_agent:rf_source_data -> Audio_ADCL_Dat_s1_agent_rsp_fifo:in_data
	wire          audio_adcl_dat_s1_agent_rf_source_ready;                                     // Audio_ADCL_Dat_s1_agent_rsp_fifo:in_ready -> Audio_ADCL_Dat_s1_agent:rf_source_ready
	wire          audio_adcl_dat_s1_agent_rf_source_startofpacket;                             // Audio_ADCL_Dat_s1_agent:rf_source_startofpacket -> Audio_ADCL_Dat_s1_agent_rsp_fifo:in_startofpacket
	wire          audio_adcl_dat_s1_agent_rf_source_endofpacket;                               // Audio_ADCL_Dat_s1_agent:rf_source_endofpacket -> Audio_ADCL_Dat_s1_agent_rsp_fifo:in_endofpacket
	wire          audio_adcl_dat_s1_agent_rsp_fifo_out_valid;                                  // Audio_ADCL_Dat_s1_agent_rsp_fifo:out_valid -> Audio_ADCL_Dat_s1_agent:rf_sink_valid
	wire  [118:0] audio_adcl_dat_s1_agent_rsp_fifo_out_data;                                   // Audio_ADCL_Dat_s1_agent_rsp_fifo:out_data -> Audio_ADCL_Dat_s1_agent:rf_sink_data
	wire          audio_adcl_dat_s1_agent_rsp_fifo_out_ready;                                  // Audio_ADCL_Dat_s1_agent:rf_sink_ready -> Audio_ADCL_Dat_s1_agent_rsp_fifo:out_ready
	wire          audio_adcl_dat_s1_agent_rsp_fifo_out_startofpacket;                          // Audio_ADCL_Dat_s1_agent_rsp_fifo:out_startofpacket -> Audio_ADCL_Dat_s1_agent:rf_sink_startofpacket
	wire          audio_adcl_dat_s1_agent_rsp_fifo_out_endofpacket;                            // Audio_ADCL_Dat_s1_agent_rsp_fifo:out_endofpacket -> Audio_ADCL_Dat_s1_agent:rf_sink_endofpacket
	wire          audio_adcl_dat_s1_agent_rdata_fifo_src_valid;                                // Audio_ADCL_Dat_s1_agent:rdata_fifo_src_valid -> Audio_ADCL_Dat_s1_agent_rdata_fifo:in_valid
	wire   [33:0] audio_adcl_dat_s1_agent_rdata_fifo_src_data;                                 // Audio_ADCL_Dat_s1_agent:rdata_fifo_src_data -> Audio_ADCL_Dat_s1_agent_rdata_fifo:in_data
	wire          audio_adcl_dat_s1_agent_rdata_fifo_src_ready;                                // Audio_ADCL_Dat_s1_agent_rdata_fifo:in_ready -> Audio_ADCL_Dat_s1_agent:rdata_fifo_src_ready
	...
	wire  [117:0] sysid_control_slave_agent_rp_data;                                           // SysID_control_slave_agent:rp_data -> router_004:sink_data
	...
	wire  [117:0] leds_s1_agent_rp_data;                                                       // LEDs_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [117:0] hex3_hex0_s1_agent_rp_data;                                                  // HEX3_HEX0_s1_agent:rp_data -> router_006:sink_data
	...
	wire          slider_switches_s1_agent_rp_valid;                                           // Slider_Switches_s1_agent:rp_valid -> router_007:sink_valid
	wire  [117:0] slider_switches_s1_agent_rp_data;                                            // Slider_Switches_s1_agent:rp_data -> router_007:sink_data
	wire          slider_switches_s1_agent_rp_ready;                                           // router_007:sink_ready -> Slider_Switches_s1_agent:rp_ready
	wire          slider_switches_s1_agent_rp_startofpacket;                                   // Slider_Switches_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire          slider_switches_s1_agent_rp_endofpacket;                                     // Slider_Switches_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire  [117:0] pushbuttons_s1_agent_rp_data;                                                // Pushbuttons_s1_agent:rp_data -> router_008:sink_data
	...
	wire          audio_ctrl_s1_agent_rp_valid;                                                // Audio_ctrl_s1_agent:rp_valid -> router_009:sink_valid
	wire  [117:0] audio_ctrl_s1_agent_rp_data;                                                 // Audio_ctrl_s1_agent:rp_data -> router_009:sink_data
	wire          audio_ctrl_s1_agent_rp_ready;                                                // router_009:sink_ready -> Audio_ctrl_s1_agent:rp_ready
	wire          audio_ctrl_s1_agent_rp_startofpacket;                                        // Audio_ctrl_s1_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire          audio_ctrl_s1_agent_rp_endofpacket;                                          // Audio_ctrl_s1_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire          audio_space_s1_agent_rp_valid;                                               // Audio_space_s1_agent:rp_valid -> router_010:sink_valid
	wire  [117:0] audio_space_s1_agent_rp_data;                                                // Audio_space_s1_agent:rp_data -> router_010:sink_data
	wire          audio_space_s1_agent_rp_ready;                                               // router_010:sink_ready -> Audio_space_s1_agent:rp_ready
	wire          audio_space_s1_agent_rp_startofpacket;                                       // Audio_space_s1_agent:rp_startofpacket -> router_010:sink_startofpacket
	wire          audio_space_s1_agent_rp_endofpacket;                                         // Audio_space_s1_agent:rp_endofpacket -> router_010:sink_endofpacket
	...
	wire          audio_dacl_dat_s1_agent_rp_valid;                                            // Audio_DACL_Dat_s1_agent:rp_valid -> router_011:sink_valid
	wire  [117:0] audio_dacl_dat_s1_agent_rp_data;                                             // Audio_DACL_Dat_s1_agent:rp_data -> router_011:sink_data
	wire          audio_dacl_dat_s1_agent_rp_ready;                                            // router_011:sink_ready -> Audio_DACL_Dat_s1_agent:rp_ready
	wire          audio_dacl_dat_s1_agent_rp_startofpacket;                                    // Audio_DACL_Dat_s1_agent:rp_startofpacket -> router_011:sink_startofpacket
	wire          audio_dacl_dat_s1_agent_rp_endofpacket;                                      // Audio_DACL_Dat_s1_agent:rp_endofpacket -> router_011:sink_endofpacket
	...
	wire          audio_adcl_dat_s1_agent_rp_valid;                                            // Audio_ADCL_Dat_s1_agent:rp_valid -> router_012:sink_valid
	wire  [117:0] audio_adcl_dat_s1_agent_rp_data;                                             // Audio_ADCL_Dat_s1_agent:rp_data -> router_012:sink_data
	wire          audio_adcl_dat_s1_agent_rp_ready;                                            // router_012:sink_ready -> Audio_ADCL_Dat_s1_agent:rp_ready
	wire          audio_adcl_dat_s1_agent_rp_startofpacket;                                    // Audio_ADCL_Dat_s1_agent:rp_startofpacket -> router_012:sink_startofpacket
	wire          audio_adcl_dat_s1_agent_rp_endofpacket;                                      // Audio_ADCL_Dat_s1_agent:rp_endofpacket -> router_012:sink_endofpacket
	...
	wire          pixel_dma_addr_translation_slave_agent_rp_valid;                             // Pixel_DMA_Addr_Translation_slave_agent:rp_valid -> router_013:sink_valid
	wire  [117:0] pixel_dma_addr_translation_slave_agent_rp_data;                              // Pixel_DMA_Addr_Translation_slave_agent:rp_data -> router_013:sink_data
	wire          pixel_dma_addr_translation_slave_agent_rp_ready;                             // router_013:sink_ready -> Pixel_DMA_Addr_Translation_slave_agent:rp_ready
	wire          pixel_dma_addr_translation_slave_agent_rp_startofpacket;                     // Pixel_DMA_Addr_Translation_slave_agent:rp_startofpacket -> router_013:sink_startofpacket
	wire          pixel_dma_addr_translation_slave_agent_rp_endofpacket;                       // Pixel_DMA_Addr_Translation_slave_agent:rp_endofpacket -> router_013:sink_endofpacket
	...
	wire   [11:0] cmd_mux_src_channel;                                                         // cmd_mux:src_channel -> AV_Config_avalon_av_config_slave_burst_adapter:sink0_channel
	...
	wire   [11:0] av_config_avalon_av_config_slave_burst_adapter_source0_channel;              // AV_Config_avalon_av_config_slave_burst_adapter:source0_channel -> AV_Config_avalon_av_config_slave_agent:cp_channel
	...
	wire   [11:0] cmd_mux_001_src_channel;                                                     // cmd_mux_001:src_channel -> VGA_Subsystem_char_buffer_control_slave_burst_adapter:sink0_channel
	...
	wire   [11:0] vga_subsystem_char_buffer_control_slave_burst_adapter_source0_channel;       // VGA_Subsystem_char_buffer_control_slave_burst_adapter:source0_channel -> VGA_Subsystem_char_buffer_control_slave_agent:cp_channel
	...
	wire  [117:0] cmd_mux_002_src_data;                                                        // cmd_mux_002:src_data -> SysID_control_slave_burst_adapter:sink0_data
	...
	wire  [117:0] cmd_mux_003_src_data;                                                        // cmd_mux_003:src_data -> LEDs_s1_burst_adapter:sink0_data
	...
	wire  [117:0] cmd_mux_004_src_data;                                                        // cmd_mux_004:src_data -> HEX3_HEX0_s1_burst_adapter:sink0_data
	wire          cmd_mux_004_src_ready;                                                       // HEX3_HEX0_s1_burst_adapter:sink0_ready -> cmd_mux_004:src_ready
	wire   [11:0] cmd_mux_004_src_channel;                                                     // cmd_mux_004:src_channel -> HEX3_HEX0_s1_burst_adapter:sink0_channel
	...
	wire  [117:0] cmd_mux_005_src_data;                                                        // cmd_mux_005:src_data -> Slider_Switches_s1_burst_adapter:sink0_data
	wire          cmd_mux_005_src_ready;                                                       // Slider_Switches_s1_burst_adapter:sink0_ready -> cmd_mux_005:src_ready
	wire   [11:0] cmd_mux_005_src_channel;                                                     // cmd_mux_005:src_channel -> Slider_Switches_s1_burst_adapter:sink0_channel
	...
	wire          cmd_mux_006_src_valid;                                                       // cmd_mux_006:src_valid -> Pushbuttons_s1_burst_adapter:sink0_valid
	wire  [117:0] cmd_mux_006_src_data;                                                        // cmd_mux_006:src_data -> Pushbuttons_s1_burst_adapter:sink0_data
	wire          cmd_mux_006_src_ready;                                                       // Pushbuttons_s1_burst_adapter:sink0_ready -> cmd_mux_006:src_ready
	wire   [11:0] cmd_mux_006_src_channel;                                                     // cmd_mux_006:src_channel -> Pushbuttons_s1_burst_adapter:sink0_channel
	wire          cmd_mux_006_src_startofpacket;                                               // cmd_mux_006:src_startofpacket -> Pushbuttons_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_006_src_endofpacket;                                                 // cmd_mux_006:src_endofpacket -> Pushbuttons_s1_burst_adapter:sink0_endofpacket
	...
	wire          cmd_mux_007_src_valid;                                                       // cmd_mux_007:src_valid -> Audio_ctrl_s1_burst_adapter:sink0_valid
	wire  [117:0] cmd_mux_007_src_data;                                                        // cmd_mux_007:src_data -> Audio_ctrl_s1_burst_adapter:sink0_data
	wire          cmd_mux_007_src_ready;                                                       // Audio_ctrl_s1_burst_adapter:sink0_ready -> cmd_mux_007:src_ready
	wire   [11:0] cmd_mux_007_src_channel;                                                     // cmd_mux_007:src_channel -> Audio_ctrl_s1_burst_adapter:sink0_channel
	wire          cmd_mux_007_src_startofpacket;                                               // cmd_mux_007:src_startofpacket -> Audio_ctrl_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_007_src_endofpacket;                                                 // cmd_mux_007:src_endofpacket -> Audio_ctrl_s1_burst_adapter:sink0_endofpacket
	wire          audio_ctrl_s1_burst_adapter_source0_valid;                                   // Audio_ctrl_s1_burst_adapter:source0_valid -> Audio_ctrl_s1_agent:cp_valid
	wire  [117:0] audio_ctrl_s1_burst_adapter_source0_data;                                    // Audio_ctrl_s1_burst_adapter:source0_data -> Audio_ctrl_s1_agent:cp_data
	wire          audio_ctrl_s1_burst_adapter_source0_ready;                                   // Audio_ctrl_s1_agent:cp_ready -> Audio_ctrl_s1_burst_adapter:source0_ready
	wire   [11:0] audio_ctrl_s1_burst_adapter_source0_channel;                                 // Audio_ctrl_s1_burst_adapter:source0_channel -> Audio_ctrl_s1_agent:cp_channel
	wire          audio_ctrl_s1_burst_adapter_source0_startofpacket;                           // Audio_ctrl_s1_burst_adapter:source0_startofpacket -> Audio_ctrl_s1_agent:cp_startofpacket
	wire          audio_ctrl_s1_burst_adapter_source0_endofpacket;                             // Audio_ctrl_s1_burst_adapter:source0_endofpacket -> Audio_ctrl_s1_agent:cp_endofpacket
	wire          cmd_mux_008_src_valid;                                                       // cmd_mux_008:src_valid -> Audio_space_s1_burst_adapter:sink0_valid
	wire  [117:0] cmd_mux_008_src_data;                                                        // cmd_mux_008:src_data -> Audio_space_s1_burst_adapter:sink0_data
	wire          cmd_mux_008_src_ready;                                                       // Audio_space_s1_burst_adapter:sink0_ready -> cmd_mux_008:src_ready
	wire   [11:0] cmd_mux_008_src_channel;                                                     // cmd_mux_008:src_channel -> Audio_space_s1_burst_adapter:sink0_channel
	wire          cmd_mux_008_src_startofpacket;                                               // cmd_mux_008:src_startofpacket -> Audio_space_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_008_src_endofpacket;                                                 // cmd_mux_008:src_endofpacket -> Audio_space_s1_burst_adapter:sink0_endofpacket
	wire          audio_space_s1_burst_adapter_source0_valid;                                  // Audio_space_s1_burst_adapter:source0_valid -> Audio_space_s1_agent:cp_valid
	wire  [117:0] audio_space_s1_burst_adapter_source0_data;                                   // Audio_space_s1_burst_adapter:source0_data -> Audio_space_s1_agent:cp_data
	wire          audio_space_s1_burst_adapter_source0_ready;                                  // Audio_space_s1_agent:cp_ready -> Audio_space_s1_burst_adapter:source0_ready
	wire   [11:0] audio_space_s1_burst_adapter_source0_channel;                                // Audio_space_s1_burst_adapter:source0_channel -> Audio_space_s1_agent:cp_channel
	wire          audio_space_s1_burst_adapter_source0_startofpacket;                          // Audio_space_s1_burst_adapter:source0_startofpacket -> Audio_space_s1_agent:cp_startofpacket
	wire          audio_space_s1_burst_adapter_source0_endofpacket;                            // Audio_space_s1_burst_adapter:source0_endofpacket -> Audio_space_s1_agent:cp_endofpacket
	wire          cmd_mux_009_src_valid;                                                       // cmd_mux_009:src_valid -> Audio_DACL_Dat_s1_burst_adapter:sink0_valid
	wire  [117:0] cmd_mux_009_src_data;                                                        // cmd_mux_009:src_data -> Audio_DACL_Dat_s1_burst_adapter:sink0_data
	wire          cmd_mux_009_src_ready;                                                       // Audio_DACL_Dat_s1_burst_adapter:sink0_ready -> cmd_mux_009:src_ready
	wire   [11:0] cmd_mux_009_src_channel;                                                     // cmd_mux_009:src_channel -> Audio_DACL_Dat_s1_burst_adapter:sink0_channel
	wire          cmd_mux_009_src_startofpacket;                                               // cmd_mux_009:src_startofpacket -> Audio_DACL_Dat_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_009_src_endofpacket;                                                 // cmd_mux_009:src_endofpacket -> Audio_DACL_Dat_s1_burst_adapter:sink0_endofpacket
	wire          audio_dacl_dat_s1_burst_adapter_source0_valid;                               // Audio_DACL_Dat_s1_burst_adapter:source0_valid -> Audio_DACL_Dat_s1_agent:cp_valid
	wire  [117:0] audio_dacl_dat_s1_burst_adapter_source0_data;                                // Audio_DACL_Dat_s1_burst_adapter:source0_data -> Audio_DACL_Dat_s1_agent:cp_data
	wire          audio_dacl_dat_s1_burst_adapter_source0_ready;                               // Audio_DACL_Dat_s1_agent:cp_ready -> Audio_DACL_Dat_s1_burst_adapter:source0_ready
	wire   [11:0] audio_dacl_dat_s1_burst_adapter_source0_channel;                             // Audio_DACL_Dat_s1_burst_adapter:source0_channel -> Audio_DACL_Dat_s1_agent:cp_channel
	wire          audio_dacl_dat_s1_burst_adapter_source0_startofpacket;                       // Audio_DACL_Dat_s1_burst_adapter:source0_startofpacket -> Audio_DACL_Dat_s1_agent:cp_startofpacket
	wire          audio_dacl_dat_s1_burst_adapter_source0_endofpacket;                         // Audio_DACL_Dat_s1_burst_adapter:source0_endofpacket -> Audio_DACL_Dat_s1_agent:cp_endofpacket
	wire          cmd_mux_010_src_valid;                                                       // cmd_mux_010:src_valid -> Audio_ADCL_Dat_s1_burst_adapter:sink0_valid
	wire  [117:0] cmd_mux_010_src_data;                                                        // cmd_mux_010:src_data -> Audio_ADCL_Dat_s1_burst_adapter:sink0_data
	wire          cmd_mux_010_src_ready;                                                       // Audio_ADCL_Dat_s1_burst_adapter:sink0_ready -> cmd_mux_010:src_ready
	wire   [11:0] cmd_mux_010_src_channel;                                                     // cmd_mux_010:src_channel -> Audio_ADCL_Dat_s1_burst_adapter:sink0_channel
	wire          cmd_mux_010_src_startofpacket;                                               // cmd_mux_010:src_startofpacket -> Audio_ADCL_Dat_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_010_src_endofpacket;                                                 // cmd_mux_010:src_endofpacket -> Audio_ADCL_Dat_s1_burst_adapter:sink0_endofpacket
	wire          audio_adcl_dat_s1_burst_adapter_source0_valid;                               // Audio_ADCL_Dat_s1_burst_adapter:source0_valid -> Audio_ADCL_Dat_s1_agent:cp_valid
	wire  [117:0] audio_adcl_dat_s1_burst_adapter_source0_data;                                // Audio_ADCL_Dat_s1_burst_adapter:source0_data -> Audio_ADCL_Dat_s1_agent:cp_data
	wire          audio_adcl_dat_s1_burst_adapter_source0_ready;                               // Audio_ADCL_Dat_s1_agent:cp_ready -> Audio_ADCL_Dat_s1_burst_adapter:source0_ready
	wire   [11:0] audio_adcl_dat_s1_burst_adapter_source0_channel;                             // Audio_ADCL_Dat_s1_burst_adapter:source0_channel -> Audio_ADCL_Dat_s1_agent:cp_channel
	wire          audio_adcl_dat_s1_burst_adapter_source0_startofpacket;                       // Audio_ADCL_Dat_s1_burst_adapter:source0_startofpacket -> Audio_ADCL_Dat_s1_agent:cp_startofpacket
	wire          audio_adcl_dat_s1_burst_adapter_source0_endofpacket;                         // Audio_ADCL_Dat_s1_burst_adapter:source0_endofpacket -> Audio_ADCL_Dat_s1_agent:cp_endofpacket
	wire          cmd_mux_011_src_valid;                                                       // cmd_mux_011:src_valid -> Pixel_DMA_Addr_Translation_slave_burst_adapter:sink0_valid
	wire  [117:0] cmd_mux_011_src_data;                                                        // cmd_mux_011:src_data -> Pixel_DMA_Addr_Translation_slave_burst_adapter:sink0_data
	wire          cmd_mux_011_src_ready;                                                       // Pixel_DMA_Addr_Translation_slave_burst_adapter:sink0_ready -> cmd_mux_011:src_ready
	wire   [11:0] cmd_mux_011_src_channel;                                                     // cmd_mux_011:src_channel -> Pixel_DMA_Addr_Translation_slave_burst_adapter:sink0_channel
	wire          cmd_mux_011_src_startofpacket;                                               // cmd_mux_011:src_startofpacket -> Pixel_DMA_Addr_Translation_slave_burst_adapter:sink0_startofpacket
	wire          cmd_mux_011_src_endofpacket;                                                 // cmd_mux_011:src_endofpacket -> Pixel_DMA_Addr_Translation_slave_burst_adapter:sink0_endofpacket
	...
	wire   [11:0] pixel_dma_addr_translation_slave_burst_adapter_source0_channel;              // Pixel_DMA_Addr_Translation_slave_burst_adapter:source0_channel -> Pixel_DMA_Addr_Translation_slave_agent:cp_channel
	...
	wire          slider_switches_s1_agent_rdata_fifo_out_valid;                               // Slider_Switches_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_005:in_0_valid
	wire   [33:0] slider_switches_s1_agent_rdata_fifo_out_data;                                // Slider_Switches_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_005:in_0_data
	wire          slider_switches_s1_agent_rdata_fifo_out_ready;                               // avalon_st_adapter_005:in_0_ready -> Slider_Switches_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_005_out_0_valid;                                           // avalon_st_adapter_005:out_0_valid -> Slider_Switches_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_005_out_0_data;                                            // avalon_st_adapter_005:out_0_data -> Slider_Switches_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_005_out_0_ready;                                           // Slider_Switches_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire    [0:0] avalon_st_adapter_005_out_0_error;                                           // avalon_st_adapter_005:out_0_error -> Slider_Switches_s1_agent:rdata_fifo_sink_error
	wire          pushbuttons_s1_agent_rdata_fifo_out_valid;                                   // Pushbuttons_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_006:in_0_valid
	wire   [33:0] pushbuttons_s1_agent_rdata_fifo_out_data;                                    // Pushbuttons_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_006:in_0_data
	wire          pushbuttons_s1_agent_rdata_fifo_out_ready;                                   // avalon_st_adapter_006:in_0_ready -> Pushbuttons_s1_agent_rdata_fifo:out_ready
	...
	wire          audio_ctrl_s1_agent_rdata_fifo_out_valid;                                    // Audio_ctrl_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_007:in_0_valid
	wire   [33:0] audio_ctrl_s1_agent_rdata_fifo_out_data;                                     // Audio_ctrl_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_007:in_0_data
	wire          audio_ctrl_s1_agent_rdata_fifo_out_ready;                                    // avalon_st_adapter_007:in_0_ready -> Audio_ctrl_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_007_out_0_valid;                                           // avalon_st_adapter_007:out_0_valid -> Audio_ctrl_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_007_out_0_data;                                            // avalon_st_adapter_007:out_0_data -> Audio_ctrl_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_007_out_0_ready;                                           // Audio_ctrl_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire    [0:0] avalon_st_adapter_007_out_0_error;                                           // avalon_st_adapter_007:out_0_error -> Audio_ctrl_s1_agent:rdata_fifo_sink_error
	wire          audio_space_s1_agent_rdata_fifo_out_valid;                                   // Audio_space_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_008:in_0_valid
	wire   [33:0] audio_space_s1_agent_rdata_fifo_out_data;                                    // Audio_space_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_008:in_0_data
	wire          audio_space_s1_agent_rdata_fifo_out_ready;                                   // avalon_st_adapter_008:in_0_ready -> Audio_space_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_008_out_0_valid;                                           // avalon_st_adapter_008:out_0_valid -> Audio_space_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_008_out_0_data;                                            // avalon_st_adapter_008:out_0_data -> Audio_space_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_008_out_0_ready;                                           // Audio_space_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_008:out_0_ready
	wire    [0:0] avalon_st_adapter_008_out_0_error;                                           // avalon_st_adapter_008:out_0_error -> Audio_space_s1_agent:rdata_fifo_sink_error
	wire          audio_dacl_dat_s1_agent_rdata_fifo_out_valid;                                // Audio_DACL_Dat_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_009:in_0_valid
	wire   [33:0] audio_dacl_dat_s1_agent_rdata_fifo_out_data;                                 // Audio_DACL_Dat_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_009:in_0_data
	wire          audio_dacl_dat_s1_agent_rdata_fifo_out_ready;                                // avalon_st_adapter_009:in_0_ready -> Audio_DACL_Dat_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_009_out_0_valid;                                           // avalon_st_adapter_009:out_0_valid -> Audio_DACL_Dat_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_009_out_0_data;                                            // avalon_st_adapter_009:out_0_data -> Audio_DACL_Dat_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_009_out_0_ready;                                           // Audio_DACL_Dat_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_009:out_0_ready
	wire    [0:0] avalon_st_adapter_009_out_0_error;                                           // avalon_st_adapter_009:out_0_error -> Audio_DACL_Dat_s1_agent:rdata_fifo_sink_error
	wire          audio_adcl_dat_s1_agent_rdata_fifo_out_valid;                                // Audio_ADCL_Dat_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_010:in_0_valid
	wire   [33:0] audio_adcl_dat_s1_agent_rdata_fifo_out_data;                                 // Audio_ADCL_Dat_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_010:in_0_data
	wire          audio_adcl_dat_s1_agent_rdata_fifo_out_ready;                                // avalon_st_adapter_010:in_0_ready -> Audio_ADCL_Dat_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_010_out_0_valid;                                           // avalon_st_adapter_010:out_0_valid -> Audio_ADCL_Dat_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_010_out_0_data;                                            // avalon_st_adapter_010:out_0_data -> Audio_ADCL_Dat_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_010_out_0_ready;                                           // Audio_ADCL_Dat_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_010:out_0_ready
	wire    [0:0] avalon_st_adapter_010_out_0_error;                                           // avalon_st_adapter_010:out_0_error -> Audio_ADCL_Dat_s1_agent:rdata_fifo_sink_error
	wire          pixel_dma_addr_translation_slave_agent_rdata_fifo_out_valid;                 // Pixel_DMA_Addr_Translation_slave_agent_rdata_fifo:out_valid -> avalon_st_adapter_011:in_0_valid
	wire   [33:0] pixel_dma_addr_translation_slave_agent_rdata_fifo_out_data;                  // Pixel_DMA_Addr_Translation_slave_agent_rdata_fifo:out_data -> avalon_st_adapter_011:in_0_data
	wire          pixel_dma_addr_translation_slave_agent_rdata_fifo_out_ready;                 // avalon_st_adapter_011:in_0_ready -> Pixel_DMA_Addr_Translation_slave_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_011_out_0_valid;                                           // avalon_st_adapter_011:out_0_valid -> Pixel_DMA_Addr_Translation_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_011_out_0_data;                                            // avalon_st_adapter_011:out_0_data -> Pixel_DMA_Addr_Translation_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_011_out_0_ready;                                           // Pixel_DMA_Addr_Translation_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_011:out_0_ready
	wire    [0:0] avalon_st_adapter_011_out_0_error;                                           // avalon_st_adapter_011:out_0_error -> Pixel_DMA_Addr_Translation_slave_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) audio_ctrl_s1_translator (
		.clk                    (System_PLL_sys_clk_clk),                      //                      clk.clk
		.reset                  (AV_Config_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (audio_ctrl_s1_agent_m0_address),              // avalon_universal_slave_0.address
		.uav_burstcount         (audio_ctrl_s1_agent_m0_burstcount),           //                         .burstcount
		.uav_read               (audio_ctrl_s1_agent_m0_read),                 //                         .read
		.uav_write              (audio_ctrl_s1_agent_m0_write),                //                         .write
		.uav_waitrequest        (audio_ctrl_s1_agent_m0_waitrequest),          //                         .waitrequest
		.uav_readdatavalid      (audio_ctrl_s1_agent_m0_readdatavalid),        //                         .readdatavalid
		.uav_byteenable         (audio_ctrl_s1_agent_m0_byteenable),           //                         .byteenable
		.uav_readdata           (audio_ctrl_s1_agent_m0_readdata),             //                         .readdata
		.uav_writedata          (audio_ctrl_s1_agent_m0_writedata),            //                         .writedata
		.uav_lock               (audio_ctrl_s1_agent_m0_lock),                 //                         .lock
		.uav_debugaccess        (audio_ctrl_s1_agent_m0_debugaccess),          //                         .debugaccess
		.av_address             (Audio_ctrl_s1_address),                       //      avalon_anti_slave_0.address
		.av_write               (Audio_ctrl_s1_write),                         //                         .write
		.av_readdata            (Audio_ctrl_s1_readdata),                      //                         .readdata
		.av_writedata           (Audio_ctrl_s1_writedata),                     //                         .writedata
		.av_chipselect          (Audio_ctrl_s1_chipselect),                    //                         .chipselect
		.av_read                (),                                            //              (terminated)
		.av_begintransfer       (),                                            //              (terminated)
		.av_beginbursttransfer  (),                                            //              (terminated)
		.av_burstcount          (),                                            //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) audio_space_s1_translator (
		.clk                    (System_PLL_sys_clk_clk),                      //                      clk.clk
		.reset                  (AV_Config_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (audio_space_s1_agent_m0_address),             // avalon_universal_slave_0.address
		.uav_burstcount         (audio_space_s1_agent_m0_burstcount),          //                         .burstcount
		.uav_read               (audio_space_s1_agent_m0_read),                //                         .read
		.uav_write              (audio_space_s1_agent_m0_write),               //                         .write
		.uav_waitrequest        (audio_space_s1_agent_m0_waitrequest),         //                         .waitrequest
		.uav_readdatavalid      (audio_space_s1_agent_m0_readdatavalid),       //                         .readdatavalid
		.uav_byteenable         (audio_space_s1_agent_m0_byteenable),          //                         .byteenable
		.uav_readdata           (audio_space_s1_agent_m0_readdata),            //                         .readdata
		.uav_writedata          (audio_space_s1_agent_m0_writedata),           //                         .writedata
		.uav_lock               (audio_space_s1_agent_m0_lock),                //                         .lock
		.uav_debugaccess        (audio_space_s1_agent_m0_debugaccess),         //                         .debugaccess
		.av_address             (Audio_space_s1_address),                      //      avalon_anti_slave_0.address
		.av_readdata            (Audio_space_s1_readdata),                     //                         .readdata
		.av_write               (),                                            //              (terminated)
		.av_read                (),                                            //              (terminated)
		.av_writedata           (),                                            //              (terminated)
		.av_begintransfer       (),                                            //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) audio_dacl_dat_s1_translator (
		.clk                    (System_PLL_sys_clk_clk),                      //                      clk.clk
		.reset                  (AV_Config_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (audio_dacl_dat_s1_agent_m0_address),          // avalon_universal_slave_0.address
		.uav_burstcount         (audio_dacl_dat_s1_agent_m0_burstcount),       //                         .burstcount
		.uav_read               (audio_dacl_dat_s1_agent_m0_read),             //                         .read
		.uav_write              (audio_dacl_dat_s1_agent_m0_write),            //                         .write
		.uav_waitrequest        (audio_dacl_dat_s1_agent_m0_waitrequest),      //                         .waitrequest
		.uav_readdatavalid      (audio_dacl_dat_s1_agent_m0_readdatavalid),    //                         .readdatavalid
		.uav_byteenable         (audio_dacl_dat_s1_agent_m0_byteenable),       //                         .byteenable
		.uav_readdata           (audio_dacl_dat_s1_agent_m0_readdata),         //                         .readdata
		.uav_writedata          (audio_dacl_dat_s1_agent_m0_writedata),        //                         .writedata
		.uav_lock               (audio_dacl_dat_s1_agent_m0_lock),             //                         .lock
		.uav_debugaccess        (audio_dacl_dat_s1_agent_m0_debugaccess),      //                         .debugaccess
		.av_address             (Audio_DACL_Dat_s1_address),                   //      avalon_anti_slave_0.address
		.av_write               (Audio_DACL_Dat_s1_write),                     //                         .write
		.av_readdata            (Audio_DACL_Dat_s1_readdata),                  //                         .readdata
		.av_writedata           (Audio_DACL_Dat_s1_writedata),                 //                         .writedata
		.av_chipselect          (Audio_DACL_Dat_s1_chipselect),                //                         .chipselect
		.av_read                (),                                            //              (terminated)
		.av_begintransfer       (),                                            //              (terminated)
		.av_beginbursttransfer  (),                                            //              (terminated)
		.av_burstcount          (),                                            //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) audio_adcl_dat_s1_translator (
		.clk                    (System_PLL_sys_clk_clk),                      //                      clk.clk
		.reset                  (AV_Config_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (audio_adcl_dat_s1_agent_m0_address),          // avalon_universal_slave_0.address
		.uav_burstcount         (audio_adcl_dat_s1_agent_m0_burstcount),       //                         .burstcount
		.uav_read               (audio_adcl_dat_s1_agent_m0_read),             //                         .read
		.uav_write              (audio_adcl_dat_s1_agent_m0_write),            //                         .write
		.uav_waitrequest        (audio_adcl_dat_s1_agent_m0_waitrequest),      //                         .waitrequest
		.uav_readdatavalid      (audio_adcl_dat_s1_agent_m0_readdatavalid),    //                         .readdatavalid
		.uav_byteenable         (audio_adcl_dat_s1_agent_m0_byteenable),       //                         .byteenable
		.uav_readdata           (audio_adcl_dat_s1_agent_m0_readdata),         //                         .readdata
		.uav_writedata          (audio_adcl_dat_s1_agent_m0_writedata),        //                         .writedata
		.uav_lock               (audio_adcl_dat_s1_agent_m0_lock),             //                         .lock
		.uav_debugaccess        (audio_adcl_dat_s1_agent_m0_debugaccess),      //                         .debugaccess
		.av_address             (Audio_ADCL_Dat_s1_address),                   //      avalon_anti_slave_0.address
		.av_readdata            (Audio_ADCL_Dat_s1_readdata),                  //                         .readdata
		.av_write               (),                                            //              (terminated)
		.av_read                (),                                            //              (terminated)
		.av_writedata           (),                                            //              (terminated)
		.av_begintransfer       (),                                            //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (System_PLL_sys_clk_clk),                            //             clk.clk
		.reset                   (AV_Config_reset_reset_bridge_in_reset_reset),       //       clk_reset.reset
		.m0_address              (audio_ctrl_s1_agent_m0_address),                    //              m0.address
		.m0_burstcount           (audio_ctrl_s1_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (audio_ctrl_s1_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (audio_ctrl_s1_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (audio_ctrl_s1_agent_m0_lock),                       //                .lock
		.m0_readdata             (audio_ctrl_s1_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (audio_ctrl_s1_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (audio_ctrl_s1_agent_m0_read),                       //                .read
		.m0_waitrequest          (audio_ctrl_s1_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (audio_ctrl_s1_agent_m0_writedata),                  //                .writedata
		.m0_write                (audio_ctrl_s1_agent_m0_write),                      //                .write
		.rp_endofpacket          (audio_ctrl_s1_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (audio_ctrl_s1_agent_rp_ready),                      //                .ready
		.rp_valid                (audio_ctrl_s1_agent_rp_valid),                      //                .valid
		.rp_data                 (audio_ctrl_s1_agent_rp_data),                       //                .data
		.rp_startofpacket        (audio_ctrl_s1_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (audio_ctrl_s1_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (audio_ctrl_s1_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (audio_ctrl_s1_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (audio_ctrl_s1_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (audio_ctrl_s1_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (audio_ctrl_s1_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (audio_ctrl_s1_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (audio_ctrl_s1_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (audio_ctrl_s1_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (audio_ctrl_s1_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (audio_ctrl_s1_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (audio_ctrl_s1_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (audio_ctrl_s1_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (audio_ctrl_s1_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (audio_ctrl_s1_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (audio_ctrl_s1_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_007_out_0_ready),                 // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_007_out_0_valid),                 //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_007_out_0_data),                  //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_007_out_0_error),                 //                .error
		.rdata_fifo_src_ready    (audio_ctrl_s1_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (audio_ctrl_s1_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (audio_ctrl_s1_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                             //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                               //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) audio_ctrl_s1_agent_rsp_fifo (
		.clk               (System_PLL_sys_clk_clk),                         //       clk.clk
		.reset             (AV_Config_reset_reset_bridge_in_reset_reset),    // clk_reset.reset
		.in_data           (audio_ctrl_s1_agent_rf_source_data),             //        in.data
		.in_valid          (audio_ctrl_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (audio_ctrl_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (audio_ctrl_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (audio_ctrl_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (audio_ctrl_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (audio_ctrl_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (audio_ctrl_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (audio_ctrl_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (audio_ctrl_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                          // (terminated)
		.csr_read          (1'b0),                                           // (terminated)
		.csr_write         (1'b0),                                           // (terminated)
		.csr_readdata      (),                                               // (terminated)
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) audio_ctrl_s1_agent_rdata_fifo (
		.clk               (System_PLL_sys_clk_clk),                      //       clk.clk
		.reset             (AV_Config_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (audio_ctrl_s1_agent_rdata_fifo_src_data),     //        in.data
		.in_valid          (audio_ctrl_s1_agent_rdata_fifo_src_valid),    //          .valid
		.in_ready          (audio_ctrl_s1_agent_rdata_fifo_src_ready),    //          .ready
		.out_data          (audio_ctrl_s1_agent_rdata_fifo_out_data),     //       out.data
		.out_valid         (audio_ctrl_s1_agent_rdata_fifo_out_valid),    //          .valid
		.out_ready         (audio_ctrl_s1_agent_rdata_fifo_out_ready),    //          .ready
		.csr_address       (2'b00),                                       // (terminated)
		.csr_read          (1'b0),                                        // (terminated)
		.csr_write         (1'b0),                                        // (terminated)
		.csr_readdata      (),                                            // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) audio_space_s1_agent (
		.clk                     (System_PLL_sys_clk_clk),                             //             clk.clk
		.reset                   (AV_Config_reset_reset_bridge_in_reset_reset),        //       clk_reset.reset
		.m0_address              (audio_space_s1_agent_m0_address),                    //              m0.address
		.m0_burstcount           (audio_space_s1_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (audio_space_s1_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (audio_space_s1_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (audio_space_s1_agent_m0_lock),                       //                .lock
		.m0_readdata             (audio_space_s1_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (audio_space_s1_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (audio_space_s1_agent_m0_read),                       //                .read
		.m0_waitrequest          (audio_space_s1_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (audio_space_s1_agent_m0_writedata),                  //                .writedata
		.m0_write                (audio_space_s1_agent_m0_write),                      //                .write
		.rp_endofpacket          (audio_space_s1_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (audio_space_s1_agent_rp_ready),                      //                .ready
		.rp_valid                (audio_space_s1_agent_rp_valid),                      //                .valid
		.rp_data                 (audio_space_s1_agent_rp_data),                       //                .data
		.rp_startofpacket        (audio_space_s1_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (audio_space_s1_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (audio_space_s1_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (audio_space_s1_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (audio_space_s1_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (audio_space_s1_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (audio_space_s1_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (audio_space_s1_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (audio_space_s1_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (audio_space_s1_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (audio_space_s1_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (audio_space_s1_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (audio_space_s1_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (audio_space_s1_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (audio_space_s1_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (audio_space_s1_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (audio_space_s1_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_008_out_0_ready),                  // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_008_out_0_valid),                  //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_008_out_0_data),                   //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_008_out_0_error),                  //                .error
		.rdata_fifo_src_ready    (audio_space_s1_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (audio_space_s1_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (audio_space_s1_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                              //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) audio_space_s1_agent_rsp_fifo (
		.clk               (System_PLL_sys_clk_clk),                          //       clk.clk
		.reset             (AV_Config_reset_reset_bridge_in_reset_reset),     // clk_reset.reset
		.in_data           (audio_space_s1_agent_rf_source_data),             //        in.data
		.in_valid          (audio_space_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (audio_space_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (audio_space_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (audio_space_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (audio_space_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (audio_space_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (audio_space_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (audio_space_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (audio_space_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                           // (terminated)
		.csr_read          (1'b0),                                            // (terminated)
		.csr_write         (1'b0),                                            // (terminated)
		.csr_readdata      (),                                                // (terminated)
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) audio_space_s1_agent_rdata_fifo (
		.clk               (System_PLL_sys_clk_clk),                      //       clk.clk
		.reset             (AV_Config_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (audio_space_s1_agent_rdata_fifo_src_data),    //        in.data
		.in_valid          (audio_space_s1_agent_rdata_fifo_src_valid),   //          .valid
		.in_ready          (audio_space_s1_agent_rdata_fifo_src_ready),   //          .ready
		.out_data          (audio_space_s1_agent_rdata_fifo_out_data),    //       out.data
		.out_valid         (audio_space_s1_agent_rdata_fifo_out_valid),   //          .valid
		.out_ready         (audio_space_s1_agent_rdata_fifo_out_ready),   //          .ready
		.csr_address       (2'b00),                                       // (terminated)
		.csr_read          (1'b0),                                        // (terminated)
		.csr_write         (1'b0),                                        // (terminated)
		.csr_readdata      (),                                            // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) audio_dacl_dat_s1_agent (
		.clk                     (System_PLL_sys_clk_clk),                                //             clk.clk
		.reset                   (AV_Config_reset_reset_bridge_in_reset_reset),           //       clk_reset.reset
		.m0_address              (audio_dacl_dat_s1_agent_m0_address),                    //              m0.address
		.m0_burstcount           (audio_dacl_dat_s1_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (audio_dacl_dat_s1_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (audio_dacl_dat_s1_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (audio_dacl_dat_s1_agent_m0_lock),                       //                .lock
		.m0_readdata             (audio_dacl_dat_s1_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (audio_dacl_dat_s1_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (audio_dacl_dat_s1_agent_m0_read),                       //                .read
		.m0_waitrequest          (audio_dacl_dat_s1_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (audio_dacl_dat_s1_agent_m0_writedata),                  //                .writedata
		.m0_write                (audio_dacl_dat_s1_agent_m0_write),                      //                .write
		.rp_endofpacket          (audio_dacl_dat_s1_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (audio_dacl_dat_s1_agent_rp_ready),                      //                .ready
		.rp_valid                (audio_dacl_dat_s1_agent_rp_valid),                      //                .valid
		.rp_data                 (audio_dacl_dat_s1_agent_rp_data),                       //                .data
		.rp_startofpacket        (audio_dacl_dat_s1_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (audio_dacl_dat_s1_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (audio_dacl_dat_s1_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (audio_dacl_dat_s1_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (audio_dacl_dat_s1_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (audio_dacl_dat_s1_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (audio_dacl_dat_s1_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (audio_dacl_dat_s1_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (audio_dacl_dat_s1_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (audio_dacl_dat_s1_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (audio_dacl_dat_s1_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (audio_dacl_dat_s1_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (audio_dacl_dat_s1_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (audio_dacl_dat_s1_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (audio_dacl_dat_s1_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (audio_dacl_dat_s1_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (audio_dacl_dat_s1_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_009_out_0_ready),                     // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_009_out_0_valid),                     //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_009_out_0_data),                      //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_009_out_0_error),                     //                .error
		.rdata_fifo_src_ready    (audio_dacl_dat_s1_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (audio_dacl_dat_s1_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (audio_dacl_dat_s1_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                                 //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                   //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) audio_dacl_dat_s1_agent_rsp_fifo (
		.clk               (System_PLL_sys_clk_clk),                             //       clk.clk
		.reset             (AV_Config_reset_reset_bridge_in_reset_reset),        // clk_reset.reset
		.in_data           (audio_dacl_dat_s1_agent_rf_source_data),             //        in.data
		.in_valid          (audio_dacl_dat_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (audio_dacl_dat_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (audio_dacl_dat_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (audio_dacl_dat_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (audio_dacl_dat_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (audio_dacl_dat_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (audio_dacl_dat_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (audio_dacl_dat_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (audio_dacl_dat_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                              // (terminated)
		.csr_read          (1'b0),                                               // (terminated)
		.csr_write         (1'b0),                                               // (terminated)
		.csr_readdata      (),                                                   // (terminated)
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) audio_dacl_dat_s1_agent_rdata_fifo (
		.clk               (System_PLL_sys_clk_clk),                       //       clk.clk
		.reset             (AV_Config_reset_reset_bridge_in_reset_reset),  // clk_reset.reset
		.in_data           (audio_dacl_dat_s1_agent_rdata_fifo_src_data),  //        in.data
		.in_valid          (audio_dacl_dat_s1_agent_rdata_fifo_src_valid), //          .valid
		.in_ready          (audio_dacl_dat_s1_agent_rdata_fifo_src_ready), //          .ready
		.out_data          (audio_dacl_dat_s1_agent_rdata_fifo_out_data),  //       out.data
		.out_valid         (audio_dacl_dat_s1_agent_rdata_fifo_out_valid), //          .valid
		.out_ready         (audio_dacl_dat_s1_agent_rdata_fifo_out_ready), //          .ready
		.csr_address       (2'b00),                                        // (terminated)
		.csr_read          (1'b0),                                         // (terminated)
		.csr_write         (1'b0),                                         // (terminated)
		.csr_readdata      (),                                             // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) audio_adcl_dat_s1_agent (
		.clk                     (System_PLL_sys_clk_clk),                                //             clk.clk
		.reset                   (AV_Config_reset_reset_bridge_in_reset_reset),           //       clk_reset.reset
		.m0_address              (audio_adcl_dat_s1_agent_m0_address),                    //              m0.address
		.m0_burstcount           (audio_adcl_dat_s1_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (audio_adcl_dat_s1_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (audio_adcl_dat_s1_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (audio_adcl_dat_s1_agent_m0_lock),                       //                .lock
		.m0_readdata             (audio_adcl_dat_s1_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (audio_adcl_dat_s1_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (audio_adcl_dat_s1_agent_m0_read),                       //                .read
		.m0_waitrequest          (audio_adcl_dat_s1_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (audio_adcl_dat_s1_agent_m0_writedata),                  //                .writedata
		.m0_write                (audio_adcl_dat_s1_agent_m0_write),                      //                .write
		.rp_endofpacket          (audio_adcl_dat_s1_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (audio_adcl_dat_s1_agent_rp_ready),                      //                .ready
		.rp_valid                (audio_adcl_dat_s1_agent_rp_valid),                      //                .valid
		.rp_data                 (audio_adcl_dat_s1_agent_rp_data),                       //                .data
		.rp_startofpacket        (audio_adcl_dat_s1_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (audio_adcl_dat_s1_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (audio_adcl_dat_s1_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (audio_adcl_dat_s1_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (audio_adcl_dat_s1_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (audio_adcl_dat_s1_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (audio_adcl_dat_s1_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (audio_adcl_dat_s1_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (audio_adcl_dat_s1_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (audio_adcl_dat_s1_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (audio_adcl_dat_s1_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (audio_adcl_dat_s1_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (audio_adcl_dat_s1_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (audio_adcl_dat_s1_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (audio_adcl_dat_s1_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (audio_adcl_dat_s1_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (audio_adcl_dat_s1_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_010_out_0_ready),                     // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_010_out_0_valid),                     //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_010_out_0_data),                      //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_010_out_0_error),                     //                .error
		.rdata_fifo_src_ready    (audio_adcl_dat_s1_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (audio_adcl_dat_s1_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (audio_adcl_dat_s1_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                                 //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                   //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) audio_adcl_dat_s1_agent_rsp_fifo (
		.clk               (System_PLL_sys_clk_clk),                             //       clk.clk
		.reset             (AV_Config_reset_reset_bridge_in_reset_reset),        // clk_reset.reset
		.in_data           (audio_adcl_dat_s1_agent_rf_source_data),             //        in.data
		.in_valid          (audio_adcl_dat_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (audio_adcl_dat_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (audio_adcl_dat_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (audio_adcl_dat_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (audio_adcl_dat_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (audio_adcl_dat_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (audio_adcl_dat_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (audio_adcl_dat_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (audio_adcl_dat_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                              // (terminated)
		.csr_read          (1'b0),                                               // (terminated)
		.csr_write         (1'b0),                                               // (terminated)
		.csr_readdata      (),                                                   // (terminated)
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) audio_adcl_dat_s1_agent_rdata_fifo (
		.clk               (System_PLL_sys_clk_clk),                       //       clk.clk
		.reset             (AV_Config_reset_reset_bridge_in_reset_reset),  // clk_reset.reset
		.in_data           (audio_adcl_dat_s1_agent_rdata_fifo_src_data),  //        in.data
		.in_valid          (audio_adcl_dat_s1_agent_rdata_fifo_src_valid), //          .valid
		.in_ready          (audio_adcl_dat_s1_agent_rdata_fifo_src_ready), //          .ready
		.out_data          (audio_adcl_dat_s1_agent_rdata_fifo_out_data),  //       out.data
		.out_valid         (audio_adcl_dat_s1_agent_rdata_fifo_out_valid), //          .valid
		.out_ready         (audio_adcl_dat_s1_agent_rdata_fifo_out_ready), //          .ready
		.csr_address       (2'b00),                                        // (terminated)
		.csr_read          (1'b0),                                         // (terminated)
		.csr_write         (1'b0),                                         // (terminated)
		.csr_readdata      (),                                             // (terminated)
	...
	Computer_System_mm_interconnect_2_router_002 router_009 (
		.sink_ready         (audio_ctrl_s1_agent_rp_ready),                //      sink.ready
		.sink_valid         (audio_ctrl_s1_agent_rp_valid),                //          .valid
		.sink_data          (audio_ctrl_s1_agent_rp_data),                 //          .data
		.sink_startofpacket (audio_ctrl_s1_agent_rp_startofpacket),        //          .startofpacket
		.sink_endofpacket   (audio_ctrl_s1_agent_rp_endofpacket),          //          .endofpacket
		.clk                (System_PLL_sys_clk_clk),                      //       clk.clk
		.reset              (AV_Config_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Computer_System_mm_interconnect_2_router_002 router_010 (
		.sink_ready         (audio_space_s1_agent_rp_ready),               //      sink.ready
		.sink_valid         (audio_space_s1_agent_rp_valid),               //          .valid
		.sink_data          (audio_space_s1_agent_rp_data),                //          .data
		.sink_startofpacket (audio_space_s1_agent_rp_startofpacket),       //          .startofpacket
		.sink_endofpacket   (audio_space_s1_agent_rp_endofpacket),         //          .endofpacket
		.clk                (System_PLL_sys_clk_clk),                      //       clk.clk
		.reset              (AV_Config_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Computer_System_mm_interconnect_2_router_002 router_011 (
		.sink_ready         (audio_dacl_dat_s1_agent_rp_ready),            //      sink.ready
		.sink_valid         (audio_dacl_dat_s1_agent_rp_valid),            //          .valid
		.sink_data          (audio_dacl_dat_s1_agent_rp_data),             //          .data
		.sink_startofpacket (audio_dacl_dat_s1_agent_rp_startofpacket),    //          .startofpacket
		.sink_endofpacket   (audio_dacl_dat_s1_agent_rp_endofpacket),      //          .endofpacket
		.clk                (System_PLL_sys_clk_clk),                      //       clk.clk
		.reset              (AV_Config_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Computer_System_mm_interconnect_2_router_002 router_012 (
		.sink_ready         (audio_adcl_dat_s1_agent_rp_ready),            //      sink.ready
		.sink_valid         (audio_adcl_dat_s1_agent_rp_valid),            //          .valid
		.sink_data          (audio_adcl_dat_s1_agent_rp_data),             //          .data
		.sink_startofpacket (audio_adcl_dat_s1_agent_rp_startofpacket),    //          .startofpacket
		.sink_endofpacket   (audio_adcl_dat_s1_agent_rp_endofpacket),      //          .endofpacket
		.clk                (System_PLL_sys_clk_clk),                      //       clk.clk
		.reset              (AV_Config_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_merlin_burst_adapter #(
		...
		.source0_valid         (audio_ctrl_s1_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (audio_ctrl_s1_burst_adapter_source0_data),          //          .data
		.source0_channel       (audio_ctrl_s1_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (audio_ctrl_s1_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (audio_ctrl_s1_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (audio_ctrl_s1_burst_adapter_source0_ready)          //          .ready
	);
	...
	altera_merlin_burst_adapter #(
		...
		.source0_valid         (audio_space_s1_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (audio_space_s1_burst_adapter_source0_data),          //          .data
		.source0_channel       (audio_space_s1_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (audio_space_s1_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (audio_space_s1_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (audio_space_s1_burst_adapter_source0_ready)          //          .ready
	);
	...
	altera_merlin_burst_adapter #(
		...
		.BURSTWRAP_CONST_VALUE     (0),
		.ADAPTER_VERSION           ("13.1")
	) audio_dacl_dat_s1_burst_adapter (
		.clk                   (System_PLL_sys_clk_clk),                                //       cr0.clk
		.reset                 (AV_Config_reset_reset_bridge_in_reset_reset),           // cr0_reset.reset
		...
		.source0_valid         (audio_dacl_dat_s1_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (audio_dacl_dat_s1_burst_adapter_source0_data),          //          .data
		.source0_channel       (audio_dacl_dat_s1_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (audio_dacl_dat_s1_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (audio_dacl_dat_s1_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (audio_dacl_dat_s1_burst_adapter_source0_ready)          //          .ready
	);
	...
	altera_merlin_burst_adapter #(
		...
		.BURSTWRAP_CONST_VALUE     (0),
		.ADAPTER_VERSION           ("13.1")
	) audio_adcl_dat_s1_burst_adapter (
		.clk                   (System_PLL_sys_clk_clk),                                //       cr0.clk
		.reset                 (AV_Config_reset_reset_bridge_in_reset_reset),           // cr0_reset.reset
		...
		.source0_valid         (audio_adcl_dat_s1_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (audio_adcl_dat_s1_burst_adapter_source0_data),          //          .data
		.source0_channel       (audio_adcl_dat_s1_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (audio_adcl_dat_s1_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (audio_adcl_dat_s1_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (audio_adcl_dat_s1_burst_adapter_source0_ready)          //          .ready
	);
	...
	Computer_System_mm_interconnect_1_avalon_st_adapter_002 #(
		...
		.in_clk_0_clk   (System_PLL_sys_clk_clk),                      // in_clk_0.clk
		.in_rst_0_reset (AV_Config_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (audio_ctrl_s1_agent_rdata_fifo_out_data),     //     in_0.data
		.in_0_valid     (audio_ctrl_s1_agent_rdata_fifo_out_valid),    //         .valid
		.in_0_ready     (audio_ctrl_s1_agent_rdata_fifo_out_ready),    //         .ready
	...
	Computer_System_mm_interconnect_1_avalon_st_adapter_002 #(
		...
		.in_clk_0_clk   (System_PLL_sys_clk_clk),                      // in_clk_0.clk
		.in_rst_0_reset (AV_Config_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (audio_space_s1_agent_rdata_fifo_out_data),    //     in_0.data
		.in_0_valid     (audio_space_s1_agent_rdata_fifo_out_valid),   //         .valid
		.in_0_ready     (audio_space_s1_agent_rdata_fifo_out_ready),   //         .ready
	...
	Computer_System_mm_interconnect_1_avalon_st_adapter_002 #(
		...
		.in_clk_0_clk   (System_PLL_sys_clk_clk),                       // in_clk_0.clk
		.in_rst_0_reset (AV_Config_reset_reset_bridge_in_reset_reset),  // in_rst_0.reset
		.in_0_data      (audio_dacl_dat_s1_agent_rdata_fifo_out_data),  //     in_0.data
		.in_0_valid     (audio_dacl_dat_s1_agent_rdata_fifo_out_valid), //         .valid
		.in_0_ready     (audio_dacl_dat_s1_agent_rdata_fifo_out_ready), //         .ready
	...
	Computer_System_mm_interconnect_1_avalon_st_adapter_002 #(
		...
		.in_clk_0_clk   (System_PLL_sys_clk_clk),                       // in_clk_0.clk
		.in_rst_0_reset (AV_Config_reset_reset_bridge_in_reset_reset),  // in_rst_0.reset
		.in_0_data      (audio_adcl_dat_s1_agent_rdata_fifo_out_data),  //     in_0.data
		.in_0_valid     (audio_adcl_dat_s1_agent_rdata_fifo_out_valid), //         .valid
		.in_0_ready     (audio_adcl_dat_s1_agent_rdata_fifo_out_ready), //         .ready
